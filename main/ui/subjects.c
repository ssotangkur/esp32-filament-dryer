...
lv_subject_t g_subject_air_temp;
...
{
    /* Initialize heater temperature subject (0-120 degrees) as float */
    lv_subject_init_float(&g_subject_heater_temp, 75.0f);
    lv_subject_set_min_value_float(&g_subject_heater_temp, 0.0f);
    lv_subject_set_max_value_float(&g_subject_heater_temp, 120.0f);

    /* Initialize air temperature subject (0-120 degrees) as float */
    lv_subject_init_float(&g_subject_air_temp, 75.0f);
    lv_subject_set_min_value_float(&g_subject_air_temp, 0.0f);
    lv_subject_set_max_value_float(&g_subject_air_temp, 120.0f);
...
void subjects_deinit(void)
{
    ...
    lv_subject_deinit(&g_subject_heater_temp);
    lv_subject_deinit(&g_subject_air_temp);
